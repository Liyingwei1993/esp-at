...
#else
#define AT_UART_RX_BUFFER_SIZE                      1024*10                   /**< uart rx buffer size */
#define AT_UART_TX_BUFFER_SIZE                      1024*8                    /**< uart tx buffer size */
#define AT_UART_QUEUE_SIZE                          100                      /**< uart queue size */
#endif
